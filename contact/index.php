				...
				<div class="container-fluid">
					<div class="row">
							<div class="bg-faded col-sm-6 text-center col-fixed">
									<div class="vMiddle">
										<h1 class="pt-4 h2">
											<span>Thank you for your offer, we will reach out to you as soon as possible.</span>
										</h1>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														<h1 class="pt-4 h2"><span class="text-green">— Daven Martel</span></h1>
														<span class="text-muted">Tech Consultant</span>
														<p><span>QC, Canada</span></p>
														<br/>
														<a target="_blank" href="https://davenmartel.com">davenmartel.com</a>
													</div>
											</div>
									</section>
							</div>
